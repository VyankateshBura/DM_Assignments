...
import BirchIMG from "./birch_clusters.png"
...
const BIRCHPLOT = ({ data, url, title }) => {
    ...
    const [branching_factor, setbranching_factor] = useState([10,30,50,70,90]);
    const [threshold, setthreshold] = useState([0.1,1.0,0.5,0.7,0.9]);
    ...
    const fetchData = async () => {
        const requestData = {
            ...
            threshold: epsValue,
            branching_factor: minSamplesValue,
        };
    ...
    <InputLabel id="eps-label">Select Branching Factor</InputLabel>
    <Select
        labelId="eps-label"
        id="eps"
        value={epsValue}
    ...
    <br></br>
    <br></br>
    <InputLabel id="min-samples-label">Select Threshold</InputLabel>
    <Select
